...
!Values related to pi and e
    ...
    REAL(rpi),  PARAMETER   ::  pi          = acos(-1.d0) 
...
!Physical constants
    ...
    REAL(rG),   PARAMETER   ::  G           = 6.673e-11_rG      ! m3 kg-1 s-2
...
!Astronomical length constants
    ...
    REAL(rAU),  PARAMETER   ::  AU          = 1.4959787066e11_dp ! in m
...
!Solar constants
    ...
    REAL(rMs),  PARAMETER   ::  M_Sun       = 1.9891e30_rMs    ! kg
...
!Half-lives and decay constants
    REAL(dp),   PARAMETER   ::  BehlMyr     = 1.387              ! in Myr
    REAL(dp),   PARAMETER   ::  Behl        = 1.387e6            ! in yr
    REAL(dp),   PARAMETER   ::  Behls       = Behl*yr            ! in s    
    REAL(dp),   PARAMETER   ::  Belambda    = LOG(2.0_dp)/Behls  ! in 1/s
    REAL(dp),   PARAMETER   ::  BelambdaMyr = LOG(2.0_dp)/BehlMyr  ! in 1/Myr
    !
    REAL(dp),   PARAMETER   ::  AlhlMyr     = 0.717              ! in Myr    
    REAL(dp),   PARAMETER   ::  Alhl        = 0.717e6            ! in yr
    REAL(dp),   PARAMETER   ::  Alhls       = Alhl*yr            ! in s
    REAL(dp),   PARAMETER   ::  Allambda    = LOG(2.0_dp)/Alhls  ! in 1/s
    REAL(dp),   PARAMETER   ::  AllambdaMyr = LOG(2.0_dp)/AlhlMyr  ! in 1/Myr
    !
    REAL(dp),   PARAMETER   ::  MnhlMyr     = 3.740              ! in Myr    
    REAL(dp),   PARAMETER   ::  Mnhl        = 3.740e6            ! in yr
    REAL(dp),   PARAMETER   ::  Mnhls       = Mnhl*yr            ! in s
    REAL(dp),   PARAMETER   ::  Mnlambda    = LOG(2.0_dp)/Mnhls  ! in 1/s
    REAL(dp),   PARAMETER   ::  MnlambdaMyr = LOG(2.0_dp)/MnhlMyr  ! in 1/Myr
    !
    REAL(dp),   PARAMETER   ::  CahlMyr     = 0.0994              ! in Myr    
    REAL(dp),   PARAMETER   ::  Cahl        = 9.940e4            ! in yr
    REAL(dp),   PARAMETER   ::  Cahls       = Cahl*yr            ! in s
    REAL(dp),   PARAMETER   ::  Calambda    = LOG(2.0_dp)/Cahls  ! in 1/s
    REAL(dp),   PARAMETER   ::  CalambdaMyr = LOG(2.0_dp)/CahlMyr  ! in 1/Myr
    !
    REAL(dp),   PARAMETER   ::  FehlMyr     = 2.620              ! in Myr    
    REAL(dp),   PARAMETER   ::  Fehl        = 2.620e6            ! in yr
    REAL(dp),   PARAMETER   ::  Fehls       = Fehl*yr            ! in s
    REAL(dp),   PARAMETER   ::  Felambda    = LOG(2.0_dp)/Fehls  ! in 1/s
    REAL(dp),   PARAMETER   ::  FelambdaMyr = LOG(2.0_dp)/FehlMyr  ! in 1/Myr
    !
    REAL(dp),   PARAMETER   ::  ClhlMyr     = 0.301              ! in Myr    
    REAL(dp),   PARAMETER   ::  Clhl        = 0.301e6            ! in yr
    REAL(dp),   PARAMETER   ::  Clhls       = Clhl*yr            ! in s
    REAL(dp),   PARAMETER   ::  Cllambda    = LOG(2.0_dp)/Clhls  ! in 1/s
    REAL(dp),   PARAMETER   ::  CllambdaMyr = LOG(2.0_dp)/ClhlMyr  ! in 1/Myr

    !Productionrates 
    REAL(dp),   PARAMETER   ::  PGCRrBe = 10.89_dp/60000.0_dp ! von dpm/kg zu atom/s/g
